...
import { getIOIP2 } from "../../api/services/EconomicActivityService";
...
export default function CustomizedTables() {
  const [ioiprows2, setIoipRows2] = useState([]);
  ...
  const fetchIOIPTable2Data = async () => {
    const data = await getIOIP2(
      setLoading,
